  ...
  return (
    <div style={{
      ...
      >
        ...
        <h3 style={{ textAlign: 'center', color: '#5A3E36', fontFamily: "'Great Vibes', cursive", fontSize: '2.2rem', margin: '0 0 5px 0' }}>
          Bela Escolha!
        </h3>
        
        <p style={{ textAlign: 'center', color: '#666', fontSize: '0.9rem', marginBottom: '20px' }}>
          Você selecionou: <strong style={{ color: '#4A6fa5' }}>{giftName}</strong>
        </p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: '10px' }}>
          <button onClick={onClose} style={{
              padding: '12px', borderRadius: '50px', border: '1px solid #D4AF37',
              background: 'transparent', color: '#D4AF37', cursor: 'pointer', fontWeight: 'bold', fontSize: '0.9rem'
            }}>
            Cancelar
          </button>
